...
function wp_seo_admin_scripts() {
	wp_enqueue_script( 'wp-seo-admin', WP_SEO_URL . 'js/wp-seo.js?v=1.2', array( 'jquery', 'underscore' ), '2.0.3', true );
...
add_action( 'admin_enqueue_scripts', 'wp_seo_admin_scripts', 10, 1 );
